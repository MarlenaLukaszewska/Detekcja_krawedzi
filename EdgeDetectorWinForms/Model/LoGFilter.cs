...
{
    /// <summary>
    /// Klasa reprezentująca filtr LoG (Laplacian of Gaussian) implementuje interfejs IFilter
    /// </summary>
    public class LoGFilter : IFilter
    {
        ...
        public Image DetectEdge(string path, bool grayScale)
        {
            ...
            return imageFactory.DetectEdges(new ImageProcessor.Imaging.Filters.EdgeDetection.LaplacianOfGaussianEdgeFilter(), grayScale).Image;
        }
    }
}
